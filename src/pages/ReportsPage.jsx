    ...
    if (activeTab === 'monthly') {
      ...
      const rows = isSimpleMode
        ...
        : [
            ...
            ['שעות בודדות', Math.round(totals.totalExtraHoursCost)],
            ['ייעוץ', Math.round(totals.totalCounselingCost)],
            ['תוספת 2 חוגים לכיתה', Math.round(totals.totalClubsExpense)],
            ...
            <div className="space-y-3">
              {(isSimpleMode
                ...
                : [
                    ...
                    ...(totals.totalClubsExpense > 0 ? [{ label: 'תוספת 2 חוגים לכיתה (600 ₪ שבועי)', value: totals.totalClubsExpense, type: 'expense' }] : []),
