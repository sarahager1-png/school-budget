    ...
    if (activeTab === 'monthly') {
      ...
      const rows = isSimpleMode
        ...
        : [
            ...
            ['שעות בודדות', Math.round(totals.totalExtraHoursCost || 0)],
            ['ייעוץ', Math.round(totals.totalCounselingCost)],
            ['תוספת חוגים לכיתה', Math.round(totals.totalClubsExpense)],
            ...
            <div className="space-y-3">
              {(isSimpleMode
                ...
                : [
                    ...
                    ...(totals.totalExtraHoursCost > 0 ? [{ label: 'שעות בודדות (חיבור כיתות, הפרדת בנים ובנות)', value: totals.totalExtraHoursCost, type: 'expense' }] : []),
                    ...
                    ...(totals.totalClubsExpense > 0 ? [{ label: 'חוגים — הוצאה שוטפת', value: totals.totalClubsExpense, type: 'expense' }] : []),
