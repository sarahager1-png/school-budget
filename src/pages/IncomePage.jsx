      ...
      {!isSimpleMode && (
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            { label: 'תל"ן — תשלומי הורים', value: totalTalan, bar: 'bg-teal-500', pct: grandTotal ? totalTalan / grandTotal * 100 : 0 },
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="text-left px-3 py-3 text-gray-500 font-medium">תל"ן</th>
              ...
              <tbody className="divide-y divide-gray-50">
                {classBreakdowns.map(cls => {
                  ...
                  return (
                    <tr key={cls.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 py-3 text-left font-medium text-teal-600">{formatCurrency(cls.budget.talanIncome)}</td>
                ...
                <tr className="bg-gray-50 border-t-2 border-gray-200">
                  ...
                  <td className="px-3 py-3 text-left font-bold text-teal-600">{formatCurrency(totalTalan)}</td>
                  <td className="px-3 py-3 text-left font-bold text-gray-800">{formatCurrency(totalMinistry + totalMinistryGrant + totalStudentIncome + totalTalan)}</td>
                </tr>
              </tbody>
            </table>
          </div>
